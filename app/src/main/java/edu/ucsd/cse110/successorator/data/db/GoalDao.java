...
public interface GoalDao {
    ...
    default int append(GoalEntity goal) {
        ...
        GoalEntity newGoal = new GoalEntity(goal.content, maxSortOrder + 1,
                false, goal.completionDate, goal.startDate, goal.pending, goal.recurring, goal.recurrenceType, goal.context, goal.prevId, goal.nextId, goal.recurrenceId, goal.recurringGenerated);

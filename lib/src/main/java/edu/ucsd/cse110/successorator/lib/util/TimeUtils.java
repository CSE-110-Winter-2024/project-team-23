...
public class TimeUtils {
    ...
    // Generated by Chat-GPT, checked for correctness
    public static String nthDayofWeek(Calendar calendar) {
        String dayOfWeekString = calendar.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.LONG, Locale.US);
        int occurrence = (calendar.get(Calendar.DAY_OF_WEEK_IN_MONTH));
        ...
        return occurrence + ordinalIndicator + " " + dayOfWeekString;
    }
}
